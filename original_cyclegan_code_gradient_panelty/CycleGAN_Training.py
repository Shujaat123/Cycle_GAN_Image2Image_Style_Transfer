...
gp_loss1    = lambda_gp * utils.wgan_gp_loss(a_real,fake_b,batch_size,training=phase,scope='gp_loss1')
gp_loss2    = lambda_gp * utils.wgan_gp_loss(b_real,fake_a,batch_size,training=phase,scope='gp_loss1')
gp_loss     = gp_loss1 + gp_loss2
...
d_loss = da_loss + db_loss + gp_loss
